...
INPUTFILE = "src\generatedData\eurocontrol\euroMerged-2021-05-11--17-46.csv"
...
def animate3dScatterLine():
      ...
      for id in pd.unique(df['UAS id']):
            dfs = df[df["UAS id"]==id]
            dataSet = dfs[["x","y","z"]].to_numpy()
...
if __name__=="__main__":
      ...
      help='Start 3d animation of path (default: %(default)s)' )
