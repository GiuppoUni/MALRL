...
if __name__ == "__main__":
   ...
   if(args.ntrajs):
      ...
      n_uavs = N_TRAJECTORIES_TO_GENERATE
   ...
   #------------------------------------------------------------------------------------------------#------------------------------------------------------------------------------------------------  
      ...
      rewLogFile.write("ELAPSEDTIME for:"+str(uav_idx)+","+str(end-start))
