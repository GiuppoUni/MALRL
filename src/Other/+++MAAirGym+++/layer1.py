...
if __name__ == "__main__":
    ...
    if(not args.skip_train):
            ...
            if(not args.random_mode):
                ...
                for i_run in range(1,n_run+1):
                    ...
                    if(i_run % 5 ==0 ):
                        ...
                        trajs3d, i_outs = trajs_utils.vertical_separate(gtrajs,assigned_trajs=trajsWithAltitude,min_height=-50,max_height=-5,sep_h = 1,radius=10, tolerance=0.20)
                        outs += i_outs
                        for t in trajs3d:
        ...
        # # trajs3d = trajs_utils.vertical_separate(trajs[2:4],min_height=-50,max_height=-5,sep_h = 1,radius=10)
        # # # trajs_utils.plot_2d(trajs[0:2])
        # # # trajs_utils.plot_2d([ trajs_utils.np_remove_z(t) for t in trajs3d[2:] ])
        # # ntrajs3d = trajs_utils.vertical_separate(trajs[0:2],assigned_trajs=trajs3d,min_height=-50,
        # #     max_height=-5,sep_h = 1,radius=1,threshold=150)
        
        # # trajs_utils.plot_3d(ntrajs3d+trajs3d)

        # trajs3d = trajs_utils.vertical_separate(trajs,min_height=-50,max_height=-5,sep_h = 1,radius=10)
