...
if __name__ == "__main__":
    ...
    # sample_points_xy = [Vector3r(-10,-10,0),Vector3r(10,-10,0),Vector3r(10,10,0),Vector3r(-10,10,0),Vector3r(-10,-10,0)]
    sample_points_xz = [Vector3r(-10,-5,-10),Vector3r(10,-5,-10),Vector3r(10,-5,10),Vector3r(-10,-5,10),Vector3r(-10,-5,-10)]
    sample_points_yz = [Vector3r(-5,-10,-10),Vector3r(-5,-10,10),Vector3r(-5,10,10),Vector3r(-5,10,-10),Vector3r(-5,-10,-10)]

    sample_points_xz2 = [Vector3r(-10,10,-10),Vector3r(10,10,-10),Vector3r(10,10,10),Vector3r(-10,10,10),Vector3r(-10,10,-10)]
    sample_points_yz2 = [Vector3r(10,-10,-10),Vector3r(10,-10,10),Vector3r(10,10,10),Vector3r(10,10,-10),Vector3r(10,-10,-10)]
    ...
    sample_points_xz2 = fix_points(sample_points_xz2)
    sample_points_yz2 = fix_points(sample_points_yz2)
    ...
    client.simPlotLineStrip(sample_points_xz2,color_rgba=[0,1,0,1],thickness=10 ,is_persistent= True)
    client.simPlotLineStrip(sample_points_yz2,color_rgba=[0,0,1,1],thickness=10 ,is_persistent= True)
