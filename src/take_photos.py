...
def main():
    ...
    vehicles_names = settings["Vehicles"]
    ...
    last_vehicle_pointer = takeoff_all_drones(client,vehicles_names)
    print("Waiting...")
    ...
    # time.sleep(0.5)
    print("Snapping images")
    images = snap_all_cams(client,vehicles_names)
    print("Saving")
    save_all_cams(images,"cam_images")
    # snap_cam(client, vehicles_names, airsim.ImageType.Infrared )
